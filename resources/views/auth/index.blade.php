    ...
    <div class="card-header">
      <div class="row flex-between-end">
        <div class="col-auto flex-lg-grow-1 flex-lg-basis-0 align-self-center">
          <h5 class="mb-0" data-anchor="data-anchor">Daftar Akaun</h5>
        </div>
...
<div class="card-body pb-3">
    <form method="POST" action="{{ route('register') }}">
        ...
        <input class="form-control" id="type" type="hidden" name="type" value="admin_register"/>
        <div class="mb-3">
            <div class="d-flex justify-content-between">
...
{{-- <div class="card-body pb-3">
    <form  method="POST" action="{{ route('register') }}">
        ...
        <div class="mb-3">
          <button class="btn btn-primary d-block w-100 mt-3" >Daftarss</button>
        </div>
    </form>
</div> --}}
