            ...
            <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column mx-lg-0 mx-auto">
              <div class="card card-plain">
                <div class="card-header pb-0 text-left">
                  ...
                  <p class="mb-0">Masukan Emel dan Kata Laluan untuk masuk</p>
                </div>
                <div class="card-body pb-3">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="mb-3">
                          <button class="btn btn-danger d-block w-100 mt-3" type="submit" name="submit">Log in</button>
                        </div>
                      </form>
                </div>
                <div class="card-footer text-center pt-0 px-sm-4 px-1">
                  <p class="mb-4 mx-auto">
                    Tiada akaun lagi?
                    <a href="{{ route('register') }}" class="text-danger text-gradient font-weight-bold">Daftar Sekarang</a>
                  </p>
                </div>
              </div>
            </div>
