                        ...
                        <table class="table table-flush dataTable-table" id="datatable-search">
                            <thead class="thead-light">
                                <tr>
                                    <th data-sortable="" style="width: 20%;"><a href="#"
                                            class="dataTable-sorter">Pekerja</a>
                                    </th>
                                    <th data-sortable="" style="width: 20%;" class="desc"><a href="#"
                                            class="dataTable-sorter">Jenis Cuti</a>
                                    </th>
                                    <th data-sortable="" style="width: 20%;">
                                        <a href="#"
                                            class="dataTable-sorter">Pindaan Cuti</a>
                                    </th>
                                    <th data-sortable="" style="width: 20%;"><a href="#"
                                            class="dataTable-sorter">Cuti Tanpa Gaji</a>
                                    </th>
                            ...
                            <tbody>
                                @foreach ($cuti as $cuti)
                                    <tr>
                                        <td class="text-sm font-weight-normal">{{ $cuti->user->name }}
                                        </td>
                                        <td class="text-sm font-weight-normal">{{ $cuti->jenisCuti }}</td>
                                        <td class="text-sm font-weight-normal">{{ $cuti->pindaanCuti }}</td>
                                        <td class="text-sm font-weight-normal">{{ $cuti->cutiTanpaGaji }}</td>
                                        ...
                                        @if (auth()->user()->role == 'admin' || auth()->user()->role == 'pengesah')
                                            ...
                                            <td class="text-sm font-weight-normal">
                                                ...
                                                @elseif ($cuti->lulus == null)
                                                    ...
                                                    <div>
                                                        <a
                                                            href="{{ route('cuti.ditolak', $cuti->id) }}">
                                                            <button type="button"
