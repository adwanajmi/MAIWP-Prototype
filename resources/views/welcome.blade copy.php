...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center">
      ...
      <div class="logo me-auto">
        {{-- <h1><a href="index.html">MAIWP</a></h1> --}}
        <!-- Uncomment below if you prefer to use an image logo -->
        <a href="index.html"><img src="assets/img/MAIWPLogo.png" alt="" class="img-fluid"></a>
      </div>
  ...
  <section id="hero" class="d-flex flex-column justify-content-center align-items-center">
    <div class="container text-center text-md-left" data-aos="fade-up">
      <h1>Selamat Datang ke portal MAIWP</h1>
      <h2>Portal ini diwujudkan bagi memudahkan urusan bayaran atas talian di Majlis Agama Islam Wilayah Persekutuan.</h2>
      <a href="#about" class="btn-get-started scrollto">Lihat Perkhidmatan Kami</a>
    </div>
  </section><!-- End Hero -->
  ...
  <main id="main">
    ...
    <section id="what-we-do" class="what-we-do">
      <div class="container">
        ...
        <div class="section-title">
          ...
          <p>PERKHIDMATAN YANG DITAWARKAN DI DALAM PORTAL e-BAITULMAL</p>
        </div>
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6">
            <img src="assets/img/MAIWP2.png" class="img-fluid" alt="">
          </div>
